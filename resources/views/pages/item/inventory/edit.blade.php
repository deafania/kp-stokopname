        ...
        <div class="container-fluid">
            ...
            <div class="card" style="width: 100%;">
                <div class="card-body pl-4">
                    ...
                    <form action="{{ route('item.update', $item->id_barang) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="col-md-5">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('stok') is-invalid @enderror" id="stok" name="stok" value="{{ $item->stok }}">
                                @error('stok')
                                    <div>
                                        <p class="text-danger">{{ $message }}</p>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select @error('id_satuanbarang') is-invalid @enderror" id="inputGroupSelect01" name="id_satuanbarang">
                                    ...
                                    @foreach ($item_units as $item_unit)
                                        <option value="{{ $item_unit->id_satuanbarang }}" @if($item->id_satuanbarang == $item_unit->id_satuanbarang) selected @endif >{{ $item_unit->satuan_barang }}</option>
                                    @endforeach
                                </select>
